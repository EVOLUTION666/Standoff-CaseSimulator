...
class TradingSortFilterView: UIView {
    ...
    private lazy var sortingLabel: UILabel = {
       let sortingLabel = UILabel()
        ...
        sortingLabel.font = UIFont.systemFont(ofSize: 12, weight: .bold)
        return sortingLabel
    }()
    ...
    private lazy var rareSortButton: UIButton = {
        ...
        rareSortButton.titleLabel?.font = UIFont.systemFont(ofSize: 12, weight: .bold)
    ...
    private lazy var priceSortButton: UIButton = {
        ...
        priceSortButton.titleLabel?.font = UIFont.systemFont(ofSize: 12, weight: .bold)
    ...
    private lazy var filterButton: UIButton = {
       let filterButton = UIButton()
        ...
        if #available(iOS 15.0, *) {
            ...
            var attributedContainer = AttributedString("Фильтр", attributes: AttributeContainer([NSAttributedString.Key.font : UIFont.systemFont(ofSize: 12, weight: .bold), NSAttributedString.Key.foregroundColor: UIColor.textPrimary]))
